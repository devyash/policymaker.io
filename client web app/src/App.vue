 ...
 <div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.html">PolicyMaker.io</a>
    </div>
    <!-- /.navbar-header -->
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-tasks">
          <li>
            <a href="#">
              <div>
                <i class="fa fa-upload fa-fw">ABC Policy</i> 
                <span class="pull-right text-muted small">11-2-2016</span>
              </div>
            </a>
          </li>
          <li class="divider"></li>
          <li>
            <a class="text-center" href="#">
              <strong>View All Pending Policy</strong>
              <i class="fa fa-angle-right"></i>
            </a>
          </li>
        </ul>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-alerts">
          <li>
            <a href="#">
              <div>
                <i class="fa fa-upload fa-fw">Florida Data</i> 
                <span class="pull-right text-muted small">11-2-2016</span>
              </div>
            </a>
          </li>
          ...
          <li>
            <a class="text-center" href="#">
              <strong>View All Pending Survey Data</strong>
              <i class="fa fa-angle-right"></i>
            </a>
          </li>
        </ul>
    ...
    <div class="navbar-default sidebar" role="navigation">
      <div class="sidebar-nav navbar-collapse">
        ...
        <li>
          <a href="#"><i class="fa fa-sitemap fa-fw"></i> About us<span class="fa arrow"></span></a>
